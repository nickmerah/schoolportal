                                 ...
                                 <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									       ...
									       <div class="item-data"><?= $stddetail->programme_option; ?></div>
									    </div><!--//col-->
  ...
  <path fill-rule="evenodd" d="M11.5 2a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zM9.05 3a2.5 2.5 0 0 1 4.9 0H16v1h-2.05a2.5 2.5 0 0 1-4.9 0H0V3h9.05zM4.5 7a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zM2.05 8a2.5 2.5 0 0 1 4.9 0H16v1H6.95a2.5 2.5 0 0 1-4.9 0H0V8h2.05zm9.45 4a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zm-2.45 1a2.5 2.5 0 0 1 4.9 0H16v1h-2.05a2.5 2.5 0 0 1-4.9 0H0v-1h9.05z"/>
							        ...
							        <div class="col-auto"> <form action="paynow" method="post">
                                ...
                                <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data"><?=$i=$i+1;?>.  <?= $feedetail->field_name; ?></div>
									    </div><!--//col-->
									    <div class="col text-right">
										   &#8358;<?= number_format($feedetail->amount); $tot += $feedetail->amount;?>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
                                
							    <!--//app-card-body--> <?php endforeach; ?><div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
                            ...
                            <?php }elseif ($fpay){ 
							echo '<b style="font-size:12px; color:#C00">Fees Have Already been Paid</b>';
