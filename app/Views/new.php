	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
                    ...
                    <b  style="color:#039">Verify your  Registration/Application Number</b><br> <br> 
			        <div class="auth-form-container text-left">
						<form class="auth-form login-form" action="../account/auth" method="post">         
							<div class="email mb-3">
								<label class="sr-only" for="signin-email">Registration/Application Number</label>
								<input id="signin-email" name="regno" type="text" class="form-control signin-email" placeholder="Registration/Application Number" required="required" autocomplete="off">
							</div><!--//form-group-->
							...
							<div class="text-center">
								<button type="submit" class="btn app-btn-primary btn-block theme-btn mx-auto">Verify</button>
							</div>
						</form>
						
						<div class="auth-option text-center pt-3">
                        <a href="<?= base_url('portal/login');?>"> <strong> &lt;&lt; Already Verified? Click Here</strong> </a> 
                       </div>
