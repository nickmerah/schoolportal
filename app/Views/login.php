		    ...
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
			        ...
			        <div class="auth-form-container text-left">
                        ...
                        <form  class="auth-form login-form"  name="app_login" 
    action="<?= base_url('account/login'); ?>" method="post">         
							<div class="email mb-3">
								<label class="sr-only" for="signin-email">Registration Number</label>
								<input id="signin-email" name="regno" type="text" class="form-control signin-email" placeholder="Registration Number" required="required" autocomplete = "off">
							</div><!--//form-group-->
							<div class="password mb-3">
								<label class="sr-only" for="signin-password">Password</label>
								<input id="signin-password" name="passkey" type="password" class="form-control signin-password" placeholder="Password" required="required">
								<div class="extra mt-3 row justify-content-between">
									...
									<div class="col-6">
										<div class="forgot-password text-right">
											<a href="<?= base_url('portal/forgotpass');?>">Forgot password?</a> 
										</div>	
									</div><!--//col-6-->
                        ...
                        <a href="<?= base_url('portal/newreg');?>"> <strong> New Registration, Begin Here</strong> <img src="<?= base_url('assets/images/new.gif')?>"  /></a> 
                       </div>
