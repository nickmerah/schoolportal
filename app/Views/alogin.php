<body class="app app-login p-0">    	
    ...
    action="<?= base_url('account/alogin'); ?>" method="post">         
							<div class="email mb-3">
								...
								<input id="signin-email" name="regno" type="text" class="form-control signin-email" placeholder="Matno" required="required" autocomplete = "off">
							</div><!--//form-group-->
							<div class="password mb-3">
								<label class="sr-only" for="signin-password">Password</label>
								<input id="signin-password" name="passkey" type="password" class="form-control signin-password" placeholder="Passkey" required="required">
