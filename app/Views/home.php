	    ...
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	
				    <div class="app-auth-branding mb-4"><a class="app-logo" href="<?= base_url();?>"><img src="<?= base_url('assets/images/schoollogo.jpg')?>" alt="logo"  ></a></div>
			        ...
			        <div class="auth-form-container text-left">
						...
						<div class="text-center">
								<button type="button" class="btn app-btn-primary btn-block theme-btn mx-auto" onClick="window.location.href='<?= base_url('portal/reginstructions');?>';"> <p>
							REGISTRATION GUIDELINES   &nbsp; </p> </button>
							</div>
							<br>
						
							<div class="text-center">
								<button type="button" class="btn app-btn-primary btn-block theme-btn mx-auto" onClick="window.location.href='<?= base_url('portal/newreg');?>';"> <p>
							 NEW REGISTRATION, BEGIN HERE  <img src="<?= base_url('assets/images/new.gif')?>"  />   &nbsp; </p> </button>
							</div>
						 <br>
						
                        
							<div class="text-center">
								<button type="button" class="btn app-btn-primary btn-block theme-btn mx-auto" onClick="window.location.href='<?= base_url('portal/login');?>';">  <p>
							STUDENTS LOGIN   &nbsp; </p> </button>
							</div>
					 <br>
                    	<?php /*	<div class="text-center">
								<button type="button" class="btn app-btn-primary btn-block theme-btn mx-auto" onClick="window.location.href='<?= base_url('portal/stdpay');?>';"> <p>
							STUDENT E-PAYMENT   &nbsp; </p> </button>
							</div>	 */ ?>				 
